...
PATH = "./Corine/model/v4/checkpoints/Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.pth"
...
def train_model(model, loss_func, optimizer, scheduler, start_epoch, train_loss, valid_loss, train_w_iou, train_m_iou, valid_w_iou, valid_m_iou, train_rmse, valid_rmse, num_epochs=25):
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        if valid_m_iou[-1] > best_iou:
            ...
            torch.save(state, "./Corine/model/v4/checkpoints/Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.pth")
        print() # end of epoch
    ...
    ax1.legend()
    plt.close(fig1)
    fig1.savefig('./Corine/model/v4/Plots/loss_Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.png')
    ...
    ax2.legend()
    plt.close(fig2)
    fig2.savefig('./Corine/model/v4/Plots/w_iou_Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.png')
    ...
    ax3.legend()
    plt.close(fig3)
    fig3.savefig('./Corine/model/v4/Plots/m_iou_Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.png')
    ...
    ax4.legend()
    plt.close(fig4)
    fig4.savefig('./Corine/model/v4/Plots/rmse_Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.png')
    
    return model

model = train_model(model, loss_func, optimizer, scheduler, start_epoch, train_loss, valid_loss, train_w_iou, train_m_iou, valid_w_iou, valid_m_iou, train_rmse, valid_rmse, num_epochs=170)
torch.save(model.state_dict(), "./Corine/model/v4/trained_models/Corine_v4_MSE_1_0_lr_1e-5_NO_Scheduler_0.pth")
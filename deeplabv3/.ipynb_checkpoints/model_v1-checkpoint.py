...
class DeepLabV3Plus(SegmentationModel):
    ...
    def __init__(
       ...
       ###############################################################################################################################
        ...
        # prova, SegmentationHead converteix a classes -> SSSR extra UP fa l'upsampling a les classes i conv3x3
        ...
        self.sssr = sssr_extra_upsampling_module(in_ch=classes, out_ch=classes)
